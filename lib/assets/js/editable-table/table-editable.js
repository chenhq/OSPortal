        ...
        init: function () {
            ...
            function cancelEditRow(rulesTable, nRow) {
                ...
                rulesTable.fnDraw();
						...
						if (typeof rulesTable=='undefined') {
								console.log('ruleTable undefined');
								rulesTable = $('#detail-table').dataTable({
										"aLengthMenu": [
												[5, 15, 20, -1],
								...
								rulesTable.fnClearTable();
						}
            // jQuery('#editable-sample_wrapper .dataTables_filter input').addClass("form-control medium"); // modify table search input
            // jQuery('#editable-sample_wrapper .dataTables_length select').addClass("form-control xsmall"); // modify table per page dropdown
						rulesTable.fnAddData(aoRules);
            ...
            $('#detail-item-new').click(function (e) {
                e.preventDefault();
								...
								.done(function(Rule) {
										...
										// 																 ]);
										var aiNew = rulesTable.fnAddDataAndDisplay(Rule);
