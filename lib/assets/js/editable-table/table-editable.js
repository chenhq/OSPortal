    ...
    return {
        ...
        init: function () {
            ...
            function saveRow(oTable, nRow) {
                ...
                oTable.fnUpdate('<a class="edit btn btn-sm btn-block btn-primary" href="">编辑</a>', nRow, 5, false);
                oTable.fnUpdate('<a class="delete btn btn-sm btn-block btn-primary" href="">删除</a>', nRow, 6, false);
                oTable.fnDraw();
            }
            ...
            $('#detail-item-new').click(function (e) {
                ...
                var aiNew = oTable.fnAddData(['', '', '', '', '',
                        '<a class="edit btn btn-sm btn-block btn-primary" href="">编辑</a>', '<a class="cancel btn btn-sm btn-block btn-primary" data-mode="new" href="">取消</a>'
                ]);
