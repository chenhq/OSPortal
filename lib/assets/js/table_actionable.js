				...
				datatable: {
						...
						"fnDrawCallback": function( oSettings ) {
								...
								icheck.on('ifChecked', function(event){
										...
										key = Object.keys(oData);
										var found = false;
										$.each(IDSelected, function(index, item) {
												if (item[key].id == oData[key].id) {
														return found = true; 
												}
										});
										if (!found) {	
								...
								$.each(IDSelected, function(index, item) {
										...
										var checkbox_selector = 'input[value=' + item[key].id + ']';
								...
								$('.show-rules').on('click', function(event) {
										...
										console.log(oData);
										modal = $('#rules-modal');
										modal.html($('#RulesModalTemplate').tmpl(oData));
										console.log('before data table...');
										console.log(modal.find('#rules-table'));
										modal.find('#rules-table').dataTable();
										modal.modal('show');
								});
